...
# CODE TO EXPLORE MULTIPLE PROPERTIES OF THE GLV MODEL WITHIN THE MU-SIGMA PHASE SPACE WITH A HOLLING NON-LINEAR INTERACTION TERM
...
fig.tight_layout()
plt.savefig("GLV_heatmaps_FigureS3B.png", format='png')
plt.close()
